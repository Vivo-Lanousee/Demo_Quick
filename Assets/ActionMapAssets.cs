...
//     version 1.13.1
//     from Assets/ActionMapAssets.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/ActionMapAssets.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @ActionMapAssets: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @ActionMapAssets()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""ActionMapAssets"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@ActionMapAssets()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, ActionMapAssets.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, ActionMapAssets.UI.Disable() has not been called.");
    }
    ...
    {
        private @ActionMapAssets m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@ActionMapAssets wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@ActionMapAssets wrapper) { m_Wrapper = wrapper; }
        /// <summary>
